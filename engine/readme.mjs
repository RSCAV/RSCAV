...
${showcase(
  '03-propiedash',
  'Propiedash, the real-estate marketplace for Venezuela. Live product screenshots, desktop and mobile.',
  'https://propiedash.com'
)}

${showcase(
  '04-opennodo',
  'OpenNodo, an open place standard for Venezuela. The live map and record explorer.',
  'https://opennodo.org'
)}
